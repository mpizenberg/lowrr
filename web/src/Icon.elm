module Icon exposing (arrowDown, arrowLeftCircle, arrowRightCircle, boundingBox, download, fileText, github, image, maximize, move, save, settings, trash, zoomFit, zoomIn, zoomOut)
